...
data class AdvancedGameStateWrapper(
...
data class AdvancedEvoAgent(
    ...
    override fun getAgentType(): String {
        return "AdvancedEvoAgent-$sequenceLength-$nEvals-$probMutation-$useShiftBuffer"
    }
...
//    internal var buffer: FloatArray? = null // randomPoint(sequenceLength)
    ...
    private fun evalSeq(state: GameState, seq: FloatArray): EvalResults {
        val wrapper = AdvancedGameStateWrapper(state.deepCopy(), params, player, opponentModel)
